    ...
    <div class="tenant-main">
        ...
        <div class="tenant-content container-fluid p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold h4 m-0">✏️ Modifier la catégorie</h2>
                    <p class="text-muted small mb-0"><?= Security::escape($category['nomCategorie'] ?? '') ?></p>
                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="idCategorieParent" class="form-select">
                                        ...
                                        <?php foreach ($parents as $parent): ?>
                                            <?php if ($parent['idCategorie'] != ($category['idCategorie'] ?? 0)): ?>
                                            <option value="<?= $parent['idCategorie'] ?>" 
                                                <?= ($category['idCategorieParent'] ?? '') == $parent['idCategorie'] ? 'selected' : '' ?>>
